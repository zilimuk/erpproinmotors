        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if(isset($value[36]))
                    {
                        $product_array['transmission'] = trim($value[36]);
                    }else
                    {
                        $product_array['transmission'] = '';
                    }
                    if(isset($value[37]))
                    {
                        $product_array['engine_capacity'] = trim($value[37]);
                    }else
                    {
                        $product_array['engine_capacity'] = '';
                    }
                    if(isset($value[38]))
                    {
                        $product_array['seats'] = trim($value[38]);
                    }else
                    {
                        $product_array['seats'] = '';
                    }
                    if(isset($value[39]))
                    {
                        $product_array['doors'] = trim($value[39]);
                    }else
                    {
                        $product_array['doors'] = '';
                    }
                    if(isset($value[40]))
                    {
                        $product_array['color'] = trim($value[40]);
                    }else
                    {
                        $product_array['color'] = '';
                    }
                    if(isset($value[41]))
                    {
                        $product_array['mileage'] = trim($value[41]);
                    }else
                    {
                        $product_array['mileage'] = '';
                    }
                    if(isset($value[42]))
                    {
                        $product_array['fuel_type'] = trim($value[42]);
                    }else
                    {
                        $product_array['fuel_type'] = '';
                    }
                    if(isset($value[43]))
                    {
                        $product_array['dimension'] = trim($value[43]);
                    }else
                    {
                        $product_array['dimension'] = '';
                    }
                    if(isset($value[44]))
                    {
                        $product_array['sterring'] = trim($value[44]);
                    }else
                    {
                        $product_array['sterring'] = '';
                    }
