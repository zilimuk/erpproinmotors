...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $form_fields = ['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 
                            'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 
                            'product_custom_field3', 'product_custom_field4', 'product_description', 
                            'sub_unit_ids','transmission','engine_capacity','seats','doors','color',
                            'mileage','fuel_type','sterring'];
            ...
            //product dimension
            $product_details['dimension'] = __('product.dimension_lenght').":".$request['dimension_lenght']." x ".
                                            __('product.dimension_width').":".$request ['dimension_width']." x ".
                                            __('product.dimension_height').":".$request['dimension_height']." x ". 
                                            __('product.dimension_m').$request['dimension_lenght']*$request ['dimension_width']*$request['dimension_height'];
    ...
    public function edit($id)
    {
        ...
        $dimension_length = $dimension[0];
        $dimension_length = trim($dimension_length,"L:");
        $product['dimension_length'] = $dimension_length;
        //get width
        $dimension_width = $dimension[1];
        $dimension_width = trim($dimension_width,"W:");
        $product['dimension_width'] = $dimension_width;
        //get height
        $dimension_height = $dimension[2];
        $dimension_height = trim($dimension_height,"H:");
        $product['dimension_height'] = $dimension_height;
        //get m
        $dimension_m = $dimension[3];
        $dimension_m = trim($dimension_m,"M:");
        $product['dimension_m'] = $dimension_m;  
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 
            'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 
            'product_custom_field3', 'product_custom_field4', 'product_description', 
            'sub_unit_ids','transmission','engine_capacity','seats','doors','color',
            'mileage','fuel_type','sterring','expiry_period','expiry_period_type']);
            ...
            //Get dimension
            $product->dimension = __('product.dimension_lenght').":".$request['dimension_lenght']." x ".
                                    __('product.dimension_width').":".$request ['dimension_width']." x ".
                                    __('product.dimension_height').":".$request['dimension_height']." x ". 
                                    __('product.dimension_m').$request['dimension_lenght']*$request ['dimension_width']*$request['dimension_height'];
            ...
            $product->transmission = $product_details['transmission'];
            $product->engine_capacity = $product_details['engine_capacity'];
            $product->seats = $product_details['seats'];
            $product->doors = $product_details['doors'];
            $product->color = $product_details['color'];
            $product->mileage = $product_details['mileage'];
            $product->fuel_type = $product_details['fuel_type'];
            $product->sterring = $product_details['sterring'];
            $product->expiry_period = $product_details['expiry_period'];
            $product->expiry_period_type = $product_details['expiry_period_type'];
    ...
    public function saveQuickProduct(Request $request)
    {
        ...
        try {
            ...
            // );
            $this->productUtil->createQuickSingleProductVariation(
                $product->id,
                $product->sku,
                $request->input('single_dpp'),
                $request->input('single_dpp_inc_tax'),
                ...
                $request->input('single_dsp_inc_tax'),
                $combo_variations,
                $request->input('additional_extra_expense_value_1'),
                $request->input('additional_extra_expense_value_2'),
                $request->input('additional_extra_expense_value_3'),
                $request->input('additional_extra_expense_value_4'),
                $request->input('additional_extra_expense_value_5'),
                $request->input('additional_extra_expense_value_6'),
                $request->input('additional_extra_expense_value_7'),
                $request->input('additional_extra_expense_value_8'),
                $request->input('additional_extra_expense_value_9'),
                $request->input('additional_extra_expense_value_10'),
                $request->input('additional_extra_expense_value_11'),
                $request->input('additional_extra_expense_value_12')
            );
