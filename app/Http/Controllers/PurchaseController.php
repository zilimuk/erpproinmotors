...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data = $request->only([ 'ref_no', 'status', 'contact_id', 'transaction_date', 'total_before_tax', 'location_id','discount_type', 'discount_amount','tax_id', 'tax_amount', 'shipping_details', 'shipping_charges', 'final_total', 'additional_notes', 'exchange_rate', 'pay_term_number', 'pay_term_type', 'purchase_order_ids','release_order','release_date','carryin_confirmation','carryin_date']);
            ...
            $transaction_data['release_date']=$this->productUtil->uf_date($transaction_data['release_date'], true);
            $transaction_data['carryin_date']=$this->productUtil->uf_date($transaction_data['carryin_date'], true);
           ...
           if(!array_key_exists('additional_extra_expense_value_1',$purchases[0]))
           {
                $purchases[0]['additional_extra_expense_value_1'] = 0;
                $purchases[0]['additional_extra_expense_value_2'] = 0;
                $purchases[0]['additional_extra_expense_value_3'] = 0;
                $purchases[0]['additional_extra_expense_value_4'] = 0;
                $purchases[0]['additional_extra_expense_value_5'] = 0;
                $purchases[0]['additional_extra_expense_value_6'] = 0;
                $purchases[0]['additional_extra_expense_value_7'] = 0;
                $purchases[0]['additional_extra_expense_value_8'] = 0;
                $purchases[0]['additional_extra_expense_value_9'] = 0;
                $purchases[0]['additional_extra_expense_value_10'] = 0;
                $purchases[0]['additional_extra_expense_value_11'] = 0;
                $purchases[0]['additional_extra_expense_value_12'] = 0;
           }
    ...
    public function edit($id)
    {
        ...
        foreach($purchase->purchase_lines as $purchase_line)
        {
          ...
          $sub_net_amount += collect([$purchase_line->variations->additional_expense_value_1,
          ...
          $purchase_line->variations->additional_expense_value_8])->sum();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $currency_details = $this->transactionUtil->purchaseCurrencyDetails($business_id);
// dd($request->purchases[0]['additional_expense_value_1']);
        ...
        //    $update_data = $request->all();
            ...
            // dd($update_data);
            // $update_data['additional_extra_expense_value_1'] = $request->purchases[0]['additional_expense_value_1'];
            DB::beginTransaction();
            ...
            {
                for($i=array_key_first($purchases);$i<count($purchases);$i++)
                    {
                    $add_extra = Variation::where('product_id',$purchases[$i]['product_id'])->first();
                    
                    if(!array_key_exists('additional_extra_expense_value_1',$purchases[$i]))
                    {
                        $purchases[$i]['additional_extra_expense_value_1'] = $add_extra['additional_expense_value_1'];
                        $purchases[$i]['additional_extra_expense_value_2'] = $add_extra['additional_expense_value_2'];
                        $purchases[$i]['additional_extra_expense_value_3'] = $add_extra['additional_expense_value_3'];
                        $purchases[$i]['additional_extra_expense_value_4'] = $add_extra['additional_expense_value_4'];
                        $purchases[$i]['additional_extra_expense_value_5'] = $add_extra['additional_expense_value_5'];
                        $purchases[$i]['additional_extra_expense_value_6'] = $add_extra['additional_expense_value_6'];
                        $purchases[$i]['additional_extra_expense_value_7'] = $add_extra['additional_expense_value_7'];
                        $purchases[$i]['additional_extra_expense_value_8'] = $add_extra['additional_expense_value_8'];
                        $purchases[$i]['additional_extra_expense_value_9'] = $add_extra['additional_expense_value_9'];
                        $purchases[$i]['additional_extra_expense_value_10'] = $add_extra['additional_expense_value_10'];
                        $purchases[$i]['additional_extra_expense_value_11'] = $add_extra['additional_expense_value_11'];
                        $purchases[$i]['additional_extra_expense_value_12'] = $add_extra['additional_expense_value_12'];
                    }
                }
            }else {
