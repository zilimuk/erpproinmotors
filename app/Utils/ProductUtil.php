...
public function createQuickSingleProductVariation($product, $sku, $purchase_price, $dpp_inc_tax, $profit_percent, $selling_price, $selling_price_inc_tax, $combo_variations = [],
                                                  $additional_expense_value_1,$additional_expense_value_2,$additional_expense_value_3,$additional_expense_value_4,$additional_expense_value_5,
                                                  $additional_expense_value_6,$additional_expense_value_7,$additional_expense_value_8,$additional_expense_value_9,$additional_expense_value_10,
                                                  $additional_expense_value_11,$additional_expense_value_12)
    {
        if (!is_object($product)) {
            $product = Product::find($product);
        }
        ...
        $product_variation = $product->product_variations()->create($product_variation_data);
            ...
            $selling_pr = $this->num_uf($selling_price);
            $additional_expense_value_1 = $this->num_uf($additional_expense_value_1);
            $additional_expense_value_2 = $this->num_uf($additional_expense_value_2);
            $additional_expense_value_3 = $this->num_uf($additional_expense_value_3);
            $additional_expense_value_4 = $this->num_uf($additional_expense_value_4);
            $additional_expense_value_5 = $this->num_uf($additional_expense_value_5);
            $additional_expense_value_6 = $this->num_uf($additional_expense_value_6);
            $additional_expense_value_7 = $this->num_uf($additional_expense_value_7);
            $additional_expense_value_8 = $this->num_uf($additional_expense_value_8);
            $additional_expense_value_9 = $this->num_uf($additional_expense_value_9);
            $additional_expense_value_10 = $this->num_uf($additional_expense_value_10);
            $additional_expense_value_11 = $this->num_uf($additional_expense_value_11);
            $additional_expense_value_12 = $this->num_uf($additional_expense_value_12);
        
            $total_addition_expenses = collect([$additional_expense_value_1,
                                                $additional_expense_value_2,$additional_expense_value_3,
                                                $additional_expense_value_4,$additional_expense_value_5,
                                                $additional_expense_value_6,$additional_expense_value_7,
                                                $additional_expense_value_8,$additional_expense_value_9,
                                                $additional_expense_value_10,$additional_expense_value_11])->sum();
            // $purchase_price = collect([$purchase_price,$total_addition_expenses])->sum();
            // $selling_pr = collect([$selling_pr,$total_addition_expenses])->sum();
            $selling_price_inc_tax = $this->num_uf($selling_price_inc_tax);
            //$selling_price_inc_tax = collect([$selling_price_inc_tax,$total_addition_expenses])->sum();
            //create variations
        $variation_data = [
                'name' => 'DUMMY',
                'product_id' => $product->id,
                ...
                'dpp_inc_tax' => $selling_pr,
                'profit_percent' => 0,
                'default_sell_price' => $selling_pr,
                'sell_price_inc_tax' => $selling_price_inc_tax,
                'combo_variations' => $combo_variations,
                'additional_expense_value_1' => $additional_expense_value_1,
                'additional_expense_value_2' => $additional_expense_value_2,
                'additional_expense_value_3' => $additional_expense_value_3,
                'additional_expense_value_4' => $additional_expense_value_4,
                'additional_expense_value_5' => $additional_expense_value_5,
                'additional_expense_value_6' => $additional_expense_value_6,
                'additional_expense_value_7' => $additional_expense_value_7,
                'additional_expense_value_8' => $additional_expense_value_8,
                'additional_expense_value_9' => $additional_expense_value_9,
                'additional_expense_value_10' => $additional_expense_value_10,
                'additional_expense_value_11' => $additional_expense_value_11,
                'additional_expense_value_12' => $additional_expense_value_12
            ];
        $variation = $product_variation->variations()->create($variation_data);
    ...
    public function updateProductFromPurchase($variation_data)
    {
        ...
        $total_extra_charges = collect([
                                        $variation_details->additional_expense_value_1,
                                        $variation_details->additional_expense_value_2,
                                        $variation_details->additional_expense_value_3,
                                        $variation_details->additional_expense_value_4,
                                        $variation_details->additional_expense_value_5,
                                        $variation_details->additional_expense_value_6,
                                        $variation_details->additional_expense_value_7,
    ...
    //                                         $variation_data['additional_expense_value_2'],
    //                                         $variation_data['additional_expense_value_3'],
    //                                         $variation_data['additional_expense_value_4'],
    //                                         $variation_data['additional_expense_value_5'],
    //                                         $variation_data['additional_expense_value_6'],
    //                                         $variation_data['additional_expense_value_7'],
    //                                         $variation_data['additional_expense_value_8'],
    //                                         $variation_data['additional_expense_value_9'],
    //                                         $variation_data['additional_expense_value_10'],
    //                                         $variation_data['additional_expense_value_11']
    //                                          ])->sum();

    //     $total_extra_charges = $total_new_additional_extra_cost - $total_old_additional_extra_cost;
        //dd($total_extra_charges.' '.$total_new_additional_extra_cost.' '.$total_old_additional_extra_cost);
//    dd($variation_details);
        ...
        if (!isset($variation_data['sell_price_inc_tax'])) {
            ...
            $variation_details->default_purchase_price = $variation_data['pp_without_discount']+ $total_extra_charges;
        ...
        $variation_details->additional_expense_value_1 = $variation_data['additional_expense_value_1'];
        $variation_details->additional_expense_value_2 = $variation_data['additional_expense_value_2'];
        $variation_details->additional_expense_value_3 = $variation_data['additional_expense_value_3'];
        $variation_details->additional_expense_value_4 = $variation_data['additional_expense_value_4'];
        $variation_details->additional_expense_value_5 = $variation_data['additional_expense_value_5'];
        $variation_details->additional_expense_value_6 = $variation_data['additional_expense_value_6'];
        $variation_details->additional_expense_value_7 = $variation_data['additional_expense_value_7'];
        $variation_details->additional_expense_value_8 = $variation_data['additional_expense_value_8'];
        $variation_details->additional_expense_value_9 = $variation_data['additional_expense_value_9'];
        $variation_details->additional_expense_value_10 = $variation_data['additional_expense_value_10'];
        $variation_details->additional_expense_value_11 = $variation_data['additional_expense_value_11'];
        $variation_details->additional_expense_value_12 = $variation_data['additional_expense_value_12'];
    ...
    public function createOrUpdatePurchaseLines($transaction, $input_data, $currency_details, $enable_product_editing, $before_status = null)
    {
        ...
        foreach ($input_data as $data) {
            ...
            if ($enable_product_editing == 1) {
                ...
                $variation_data['additional_expense_value_1'] = $this->num_uf($data['additional_extra_expense_value_1']);
                $variation_data['additional_expense_value_2'] = $this->num_uf($data['additional_extra_expense_value_2']);
                $variation_data['additional_expense_value_3'] = $this->num_uf($data['additional_extra_expense_value_3']);
                $variation_data['additional_expense_value_4'] = $this->num_uf($data['additional_extra_expense_value_4']);
                $variation_data['additional_expense_value_5'] = $this->num_uf($data['additional_extra_expense_value_5']);
                $variation_data['additional_expense_value_6'] = $this->num_uf($data['additional_extra_expense_value_6']);
                $variation_data['additional_expense_value_7'] = $this->num_uf($data['additional_extra_expense_value_7']);
                $variation_data['additional_expense_value_8'] = $this->num_uf($data['additional_extra_expense_value_8']);
                $variation_data['additional_expense_value_9'] = $this->num_uf($data['additional_extra_expense_value_9']);
                $variation_data['additional_expense_value_10'] = $this->num_uf($data['additional_extra_expense_value_10']);
                $variation_data['additional_expense_value_11'] = $this->num_uf($data['additional_extra_expense_value_11']);
                $variation_data['additional_expense_value_12'] = $this->num_uf($data['additional_extra_expense_value_12']);
     ...
     $variation_details = Variation::where('id', $variation_data['variation_id'])
            ...
            //                     $variation_data['additional_expense_value_11']
            //                     ])->sum();
                                // dd($total_new_additional_extra_cost);
            // $total_extra_charges = $total_new_additional_extra_cost - $total_old_additional_extra_cost;
...
//$total_old_additional_extra_cost = collect([
    //                                     $variation_details->additional_expense_value_1,
    //                                     $variation_details->additional_expense_value_2,
    //                                     $variation_details->additional_expense_value_3,
    //                                     $variation_details->additional_expense_value_4,
    ...
    //                                         $variation_data['additional_expense_value_10'],
    //                                         $variation_data['additional_expense_value_11'],
    //                                         $variation_data['additional_expense_value_12'],
    //                                          ])->sum();