...
$(document).ready(function() {
    ...
    $(document).on('change', '.purchase_quantity', function() {
     ...
     //calculate extra charges
            var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
            var additional_extra_expense_2 = __read_number(row.find('input#additional_extra_expense_value_2'),true);
            var additional_extra_expense_3 = __read_number(row.find('input#additional_extra_expense_value_3'),true);
            var additional_extra_expense_4 = __read_number(row.find('input#additional_extra_expense_value_4'),true);
            var additional_extra_expense_5 = __read_number(row.find('input#additional_extra_expense_value_5'),true);
            var additional_extra_expense_6 = __read_number(row.find('input#additional_extra_expense_value_6'),true);
            var additional_extra_expense_7 = __read_number(row.find('input#additional_extra_expense_value_7'),true);
            var additional_extra_expense_8 = __read_number(row.find('input#additional_extra_expense_value_8'),true);
            var additional_extra_expense_9 = __read_number(row.find('input#additional_extra_expense_value_9'),true);
            var additional_extra_expense_10 = __read_number(row.find('input#additional_extra_expense_value_10'),true);
            var additional_extra_expense_11 = __read_number(row.find('input#additional_extra_expense_value_11'),true);
            var additional_extra_expense_12 = __read_number(row.find('input#additional_extra_expense_value_12'),true);
...
// Extra charges
    $(document).on('change', '.additional_extra_expense_value_1', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_1 = __read_number($(this), true);
    ...
    $(document).on('change', '.additional_extra_expense_value_2', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_2 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_3', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_3 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_4', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_4 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_5', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_5 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_6', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_6 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
 ...
 $(document).on('change', '.additional_extra_expense_value_7', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_7 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_8', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_8 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_9', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_9 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_10', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_10 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_11', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_11 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
    ...
    $(document).on('change', '.additional_extra_expense_value_12', function() {
       
        var row = $(this).closest('tr');
        var additional_extra_expense_12 = __read_number($(this), true);
        var purchase_after_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'),true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        //calculate extra charges
        var additional_extra_expense_1 = __read_number(row.find('input#additional_extra_expense_value_1'),true);
...
function update_purchase_entry_row_values(row) {
    if (typeof row != 'undefined') {
        ...
        var unit_additional_tax = additional_extra_expense_12+additional_extra_expense_3 * 0.18;
...
function update_table_total() {
    ...
    $('#purchase_entry_table tbody')
        ...
        .each(function() {
            ...
            //calculate extra charges
        var additional_extra_expense_1 = __read_number($(this).find('input#additional_extra_expense_value_1'),true);
        var additional_extra_expense_2 = __read_number($(this).find('input#additional_extra_expense_value_2'),true);
        var additional_extra_expense_3 = __read_number($(this).find('input#additional_extra_expense_value_3'),true);
        var additional_extra_expense_4 = __read_number($(this).find('input#additional_extra_expense_value_4'),true);
        var additional_extra_expense_5 = __read_number($(this).find('input#additional_extra_expense_value_5'),true);
        var additional_extra_expense_6 = __read_number($(this).find('input#additional_extra_expense_value_6'),true);
        var additional_extra_expense_7 = __read_number($(this).find('input#additional_extra_expense_value_7'),true);
        var additional_extra_expense_8 = __read_number($(this).find('input#additional_extra_expense_value_8'),true);
        var additional_extra_expense_9 = __read_number($(this).find('input#additional_extra_expense_value_9'),true);
        var additional_extra_expense_10 = __read_number($(this).find('input#additional_extra_expense_value_10'),true);
        var additional_extra_expense_11 = __read_number($(this).find('input#additional_extra_expense_value_11'),true);
        var additional_extra_expense_12 = __read_number($(this).find('input#additional_extra_expense_value_12'),true);
...
function update_grand_total() {
    ...
    // __write_number($('input#tax_amount'), tax);
    // $('#tax_calculated_amount').text(__currency_trans_from_en(tax, true, true));
   var tax =  __read_number($('input#tax_amount'), true)
    //Calculate shipping
    ...
    grand_total = total_subtotal - discount + shipping_charges + 
