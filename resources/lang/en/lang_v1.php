...
return [
    ...
    'barcode_label_error' => 'Unsupported Chasis number id for the selected barcode type',
    'list_products' => 'List Cars',
    ...
    'enable_brand' => 'Enable Classification',
    'enable_category' => 'Enable Make',
    'enable_sub_category' => 'Enable Model',
    ...
    'tooltip_calculation_percentage' => '<b>Selling price = Selling price Set For the car + Calculation percentage </b> <br/><br/> You can specify percentage as positive to increase and negtive to decrease selling price.',
    'success' => 'Success',
    ...
    'tooltip_sr_no' => 'Enable or disable adding product description, IMEI or Serial number while selling car in POS screen',
    ...
    'suppliers' => 'Suppliers',
    'customers' => 'Customers',
    'enter_product_name_to_print_labels' => 'Enter car name to print labels',
    'manage_product_variations' => 'Manage car variations',
    ...
    'pending' => 'Pending',
    'ordered' => 'Ordered',
    'search_product_placeholder' => 'Enter car name / Chasis number / Scan bar code',
    'fixed' => 'Fixed',
    ...
    'product_purchase_report' => 'Car Purchase Report',
    'unit_perchase_price' => 'Unit Purchase Price',
    'search_product' => 'Search Car',
    'product_sell_report' => 'Car Sell Report',
    'unit_sale_price' => 'Unit Sale Price',
    'contact_id' => 'Contact ID',
    'category_code_help' => "Car code is same as <b>HSN code</b>",
    'sub_heading_line' => 'Sub Heading Line :_number_',
    'date_label' => 'Date Label',
    'client_id_label' => 'Client ID Label',
    'product_label' => 'Car Label',
    'qty_label' => 'Quantity Label',
    'unit_price_label' => 'Unit Price Label',
    'subtotal_label' => 'Subtotal Label',
    'product_details_to_be_shown' => 'Car details to be shown',
    'show_brand' => 'Show brand',
    'show_sku' => 'Show Chasis number',
    'show_cat_code' => 'Show Make code or HSN code',
    ...
    'sku_ins' => 'Car Chasis number. If blank an Chasis number will be automatically generated',
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'product_stock_details' => 'Car Stock Details',
    'search' => 'Search',
    ...
    'product_not_found_exception' => 'Product with chasis number :sku not found  on row :row',
    ...
    'weighing_product_sku_length' => 'Car Chasis number length',
    ...
    'sku_not_match' => 'No Car found with Chasis number :sku',
    ...
    'import_sale_product_not_found' => 'Car with name :product_name or Chasis number :sku not found in row :row',
    ...
    'product_name_or_sku_is_required' => 'Car name or Chasis number is required',
    ...
    'product_cannot_be_empty_in_row' => 'Either car name or car chasis number is required in row :row',
    ...
    'either_product_name_or_sku_required' => 'Either car name (for single and combo only) or car chasis number required',
    ...
    'add_additional_expenses' => 'Add Extra charges',
    'additional_expense_name' => 'Extra charges',
    ...
    'carryout_date' => 'Carry Out Date',
    'carryout_details' => 'Carry Out Details',
    'release_details' => 'Release Details',
    'extra_charges' => 'Extra Charges',
    'business_location_custom_field_1' => 'TIN'
];
