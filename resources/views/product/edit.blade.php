    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <option value="{{$product->transmission}}">{{$product->transmission}} </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('engine_capacity', __('product.engine_capacity') . ':*') !!}
              {!! Form::number('engine_capacity',$product->engine_capacity, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('seats', __('product.seats') . ':*') !!}
              {!! Form::number('seats',$product->seats, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('doors', __('product.doors') . ':*') !!}
              {!! Form::number('doors',$product->doors, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('color', __('product.color') . ':*') !!}
              {!! Form::text('color',$product->color, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('mileage', __('product.mileage') . ':*') !!}
              {!! Form::number('mileage',$product->mileage, ['class' => 'form-control input-number', 'required',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('fuel_type', __('product.fuel_type') . ':*') !!}
              ...
              <option value="{{$product->fuel_type}}">{{$product->fuel_type}}</option>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('steering', __('product.steering') . ':*') !!}
              ...
              <option value="{{$product->sterring}}"> {{ $product->sterring?$product->sterring: "Null" }}</option>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('dimension', __('product.dimension') . ':*') !!}<br>
              ...
              <div class="col-sm-2">
                  <div class="form-group">
                  {!! Form::number('dimension_lenght',$product->dimension_length, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_lenght').':'.$product->dimension_length]); !!}
              </div>
              </div>
              <div class="col-sm-2">
                  <div class="form-group">
                  {!! Form::number('dimension_width',$product->dimension_width, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_width').':'.$product->dimension_width]); !!}
              </div>
              </div>
              <div class="col-sm-2">
                  <div class="form-group">
                  {!! Form::number('dimension_height',$product->dimension_height, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_height').':'.$product->dimension_height]); !!}
              </div>
              </div>
              
              {{-- <div class="col-sm-2">
                  <div class="form-group">
                  {!! Form::number('dimension_m',$product->dimension_m, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_m').$product->dimension_m]); !!}
              </div>
              </div> --}}
        </div>
        </div>
            ...
            <div class="form-group">
              <div class="multi-input">
                ...
                @endphp
                  ...
                  {!! Form::select('expiry_period_type', ['months'=>__('product.months'), 'days'=>__('product.days'), '' =>__('product.not_applicable') ], $product->expiry_period_type, ['class' => 'form-control select2 pull-left', 'style' => 'width:40%;', 'id' => 'expiry_period_type']); !!}
              </div>
            </div>
          </div>
          @endif
