  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('transmission', __('product.transmission') . ':') !!}
            <select name="transmission" class="form-control custom-select " required>
            <option >Please select </div>
            <option value='Automatic'>@lang('product.transmission_automatic')</div>
            <option value="Manual">@lang('product.transmission_manual')</div>
            <option value="Both">@lang('product.transmission_both')</div>
            </select>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('engine_capacity', __('product.engine_capacity') . ':*') !!}
              {!! Form::number('engine_capacity',null, ['class' => 'form-control', 'required',
              'placeholder' => __('product.engine_capacity')]); !!}
        </div>
         </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('seats', __('product.seats') . ':*') !!}
              {!! Form::number('seats',null, ['class' => 'form-control', 'required',
              'placeholder' => __('product.seats')]); !!}
        </div>
         </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('doors', __('product.doors') . ':*') !!}
              {!! Form::number('doors',null, ['class' => 'form-control', 'required',
              'placeholder' => __('product.doors')]); !!}
        </div>
         </div>
        <div class="col-sm-4">
          <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('mileage', __('product.mileage') . ':*') !!}
              {!! Form::number('mileage',null, ['class' => 'form-control input-number', 'required',
              'placeholder' => __('product.mileage')]); !!}
        </div>
         </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('fuel_type', __('product.fuel_type') . ':*') !!}
              <select name="fuel_type" class="form-control custom-select" required>
              <option >Please select </option>
              <option value="Petrol">@lang('product.fuel_type_petrol')</option>
              <option value="Diseal">@lang('product.fuel_type_diseal')</option>
            </select>
        </div>
         </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('steering', __('product.steering') . ':*') !!}
              <select name="sterring" class="form-control custom-select" required>
              <option >Please select </option>
              <option value="Right Hand">@lang('product.steering_right')</option>
              <option value="Left Hand">@lang('product.steering_left')</option>
            </select>
        </div>
         </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('dimension', __('product.dimension') . ':*') !!}<br>
              <div class="col-sm-3">
                  <div class="form-group">
                  {!! Form::number('dimension_lenght',null, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_lenght')]); !!}
              </div>
              </div>
              <div class="col-sm-3">
                  <div class="form-group">
                  {!! Form::number('dimension_width',null, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_width')]); !!}
              </div>
              </div>
              <div class="col-sm-3">
                  <div class="form-group">
                  {!! Form::number('dimension_height',null, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_height')]); !!}
              </div>
              </div>
              {{-- <div class="col-sm-2">
                  <div class="form-group">
                  {!! Form::number('dimension_m',null, ['class' => 'form-control', 'required',
                      'placeholder' => __('product.dimension_m')]); !!}
              </div>
              </div> --}}
        </div>
        </div>
      ...
      @if(auth()->user()->can("purchase.add_extra_charges") && auth()->user()->can("purchase.update_extra_charges") )
       ...
       <div class="col-sm-12">
          <div class="form-group text-center">
            <h3>@lang('lang_v1.extra_charges')</h3>
          </div>
      </div>
       <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_1',  __('product.extra_charges_1') . ':') !!}
            {!! Form::text('additional_extra_expense_value_1', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_1','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_2',  __('product.extra_charges_2') . ':') !!}
            {!! Form::text('additional_extra_expense_value_2', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_2','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_3',  __('product.extra_charges_3') . ':') !!}
            {!! Form::text('additional_extra_expense_value_3', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_3','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_4',  __('product.extra_charges_4') . ':') !!}
            {!! Form::text('additional_extra_expense_value_4', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_4','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_5',  __('product.extra_charges_5') . ':') !!}
            {!! Form::text('additional_extra_expense_value_5', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_5','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_6',  __('product.extra_charges_6') . ':') !!}
            {!! Form::text('additional_extra_expense_value_6', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_6','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_extra_expense_key_7',  __('product.extra_charges_7') . ':') !!}
            {!! Form::text('additional_extra_expense_value_7', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_7','required']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_8',  __('product.extra_charges_8') . ':') !!}
            {!! Form::text('additional_extra_expense_value_8', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_8','required']); !!}
          </div>
        </div>

        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_9',  __('product.extra_charges_9') . ':') !!}
            {!! Form::text('additional_extra_expense_value_9', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_9','required']); !!}
          </div> 
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_10',  __('product.extra_charges_10') . ':') !!}
            {!! Form::text('additional_extra_expense_value_10', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_10','required']); !!}
          </div> 
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_11',  __('product.extra_charges_11') . ':') !!}
            {!! Form::text('additional_extra_expense_value_11', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_11','required']); !!}
          </div> 
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('additional_expense_key_12',  __('product.extra_charges_12') . ':') !!}
            {!! Form::text('additional_extra_expense_value_12', 0, ['class' => 'form-control input_number', 'id' => 'additional_extra_expense_value_12','required']); !!}
          </div> 
        </div>
      </div>
    </div>
