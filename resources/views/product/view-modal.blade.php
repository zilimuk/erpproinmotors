      		...
      		<div class="row">
      			<div class="col-sm-9">
	      			...
	      			<div class="col-sm-4 invoice-col">
						...
						<b>@lang('product.transmission'):</b>
						{{$product->transmission}}<br>
						<b>@lang('product.engine_capacity'):</b>
						{{$product->engine_capacity}}<br>
						<b>@lang('product.seats'):</b>
						{{$product->seats}}<br>
						<b>@lang('product.doors'):</b>
						{{$product->doors}}<br>
						<b>@lang('product.color'):</b>
						{{$product->color}}<br>
						<b>@lang('product.mileage'):</b>
						{{$product->mileage}}<br>
						<b>@lang('product.fuel_type'):</b>
						{{$product->fuel_type}}<br>
						<b>@lang('lang_v1.weight'):</b>
						{{$product->weight}}<br>
						<b>@lang('product.dimension'):</b>
						{{$product->dimension}}<br>
						<b>@lang('product.steering'):</b>
						{{$product->sterring}}<br>
