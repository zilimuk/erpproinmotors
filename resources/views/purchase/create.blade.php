...
<section class="content">
					...
					<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
						<thead class="thead">
							<tr>
								...
								<th style="padding-right: 30px;">@lang( 'purchase.purchase_quantity' )</th>
								<th  style="padding-right: 90px;padding-left: 90px">@lang( 'lang_v1.unit_cost_before_discount' )</th>
								<th style="padding-right: 30px;">@lang( 'lang_v1.discount_percent' )</th>
								...
								<th  style="padding-right: 90px;padding-left: 90px" class="@if(!session('business.enable_editing_product_from_purchase')) hide @endif">
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary'])
	{!! Form::hidden('shipping_charges', 0, ['class' => 'form-control input_number', 'required']); !!}
	{!! Form::hidden('additional_expense_value_1', 0, ['class' => 'form-control input_number', 'id' => 'additional_expense_value_1']); !!}
	{!! Form::hidden('additional_expense_value_2', 0, ['class' => 'form-control input_number', 'id' => 'additional_expense_value_2']); !!}
	{!! Form::hidden('additional_expense_value_3', 0, ['class' => 'form-control input_number', 'id' => 'additional_expense_value_3']); !!}
	{!! Form::hidden('additional_expense_value_4', 0, ['class' => 'form-control input_number', 'id' => 'additional_expense_value_4']); !!}
	...
	@endcomponent
	{{-- custom Port/shipping details  --}}
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_port_details')])
		<div class="row">
				<div class="col-md-3">
						<div class="form-group">
						{!! Form::label('release_order', __('purchase.release_order') . ':*') !!}
						<select name="release_order" id="release_order" class="form-control select2" placeholder="'Please Select'" required>
							<option value=""  selected>@lang('lang_v1.none')</option>
				...
				<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('release_date', __('purchase.release_date') . ':*') !!}
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</span>
						{!! Form::text('release_date', @format_datetime('now'), ['class' => 'form-control','id'=>'release_date','readonly', 'required']); !!}
					</div>
				</div>
				...
				<div class="col-md-3">
						<div class="form-group">
						{!! Form::label('carryin_confirmation', __('purchase.carryin_confirmation') . ':*') !!}
						<select name="carryin_confirmation" id="carryin_confirmation" class="form-control select2" placeholder="'Please Select'" required>
							<option value=""  selected>@lang('lang_v1.none')</option>
							<option value="Yes">Yes</option>
							<option value="No">No</option>
						</select>
				...
				<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('carryin_date', __('purchase.carryin_date') . ':*') !!}
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</span>
						{!! Form::text('carryin_date', @format_datetime('now'), ['class' => 'form-control','id'=>'carryin_date','readonly','required']); !!}
					</div>
				</div>
