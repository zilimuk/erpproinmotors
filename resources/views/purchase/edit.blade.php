	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_port_details')])
		<div class="row">
				<div class="col-md-3">
						...
						<select name="release_order" id="release_order" class="form-control select2" placeholder="'Please Select'">
							<option value="{!!$purchase->release_order!!}"  selected>{!!$purchase->release_order!!}</option>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text('release_date', $purchase->release_date, ['class' => 'form-control','id'=>'release_date','readonly', 'required']); !!}
					</div>
				</div>
				...
				<div class="col-md-3">
						...
						<select name="carryin_confirmation" id="carryin_confirmation" class="form-control select2" placeholder="'Please Select'">
							<option value="{!! $purchase->carryin_confirmation !!}"  selected>{!! $purchase->carryin_confirmation !!}</option>
							<option value="Yes">Yes</option>
							<option value="No">No</option>
						</select>
						</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text('carryin_date', $purchase->carryin_date, ['class' => 'form-control','id'=>'carryin_date','readonly','required']); !!}
					</div>
				</div>
