...
<div class="table-responsive">
    <table class="table table-bordered table-th-green text-center table-striped w-auto" 
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th  style="padding-right: 90px;padding-left: 90px">@lang( 'lang_v1.unit_cost_before_discount' )</th>
                <th  style="padding-right: 20px;padding-left: 20px">@lang( 'lang_v1.discount_percent' )</th>
                <th  style="padding-right: 90px;padding-left: 90px">@lang( 'purchase.unit_cost_before_tax' )</th>
                <th   style="padding-right: 90px;padding-left: 90px" class="{{$hide_tax}}">@lang( 'purchase.subtotal_before_tax' )</th>
                <th   style="padding-right: 90px;padding-left: 90px" class="{{$hide_tax}}">@lang( 'purchase.product_tax' )</th>
                <th  style="padding-right: 90px;padding-left: 90px" class="{{$hide_tax}}">@lang( 'purchase.net_cost' )</th>
                <th  style="padding-right: 90px;padding-left: 90px">@lang( 'purchase.line_total' )</th>
                <th  style="padding-right: 90px;padding-left: 90px" class="@if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif">
                    @lang( 'lang_v1.profit_margin' )
                </th>
                @if(empty($is_purchase_order))
                    <th  style="padding-right: 90px;padding-left: 90px">@lang( 'purchase.unit_selling_price') <small>(@lang('product.inc_of_tax'))</small></th>
                    @if(session('business.enable_lot_number'))
                        <th  style="padding-right: 90px;padding-left: 90px">
                    ...
                    @endif --}}
                @endif
                @if(auth()->user()->can("purchase.add_extra_charges") && auth()->user()->can("purchase.update_extra_charges") )
        ...
        <tr @if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])) data-purchase_order_id="{{$purchase_line->purchase_order_line->transaction_id}}" @endif>
            ...
            <td class="{{$hide_tax}}">
                <span class="row_subtotal_before_tax">
                    {{number_format($purchase_line->quantity * $purchase_line->purchase_price +$purchase_line->variations->additional_expense_value_1
                    +$purchase_line->variations->additional_expense_value_2 + $purchase_line->variations->additional_expense_value_3
                    +$purchase_line->variations->additional_expense_value_4+$purchase_line->variations->additional_expense_value_5
            ...
            <td class="{{$hide_tax}}">
                <div class="input-group">
                    <select name="purchases[{{ $loop->index }}][purchase_line_tax_id]" class="form-control input-sm purchase_line_tax_id" placeholder="'Please Select'">
                        ...
                        {{-- {{ $tax->amount }} --}}
                            <option value="{{ $tax->id }}" data-tax_amount="0" @if( $purchase_line->tax_id == $tax->id) selected @endif >{{ $tax->name }}</option>
                        @endforeach
                    </select>
            ...
            <td>
                ...
                <input type="hidden" class="row_subtotal_after_tax_hidden" value="{{number_format($purchase_line->purchase_price_inc_tax * $purchase_line->quantity + $purchase_line->variations->additional_expense_value_1 
                                    + $purchase_line->variations->additional_expense_value_2 + $purchase_line->variations->additional_expense_value_3
                                    + $purchase_line->variations->additional_expense_value_4 + $purchase_line->variations->additional_expense_value_5
                                    + $purchase_line->variations->additional_expense_value_6 + $purchase_line->variations->additional_expense_value_7
                                    +$purchase_line->variations->additional_expense_value_8+$purchase_line->variations->additional_expense_value_9
            ...
            @if(auth()->user()->can("purchase.add_extra_charges") && auth()->user()->can("purchase.update_extra_charges") )
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_1]',number_format($purchase_line->variations->additional_expense_value_1), ['class' => 'form-control input-sm additional_extra_expense_value_1 input_number', 'id' => 'additional_extra_expense_value_1']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_2]',number_format($purchase_line->variations->additional_expense_value_2), ['class' => 'form-control input-sm additional_extra_expense_value_2 input_number', 'id' => 'additional_extra_expense_value_2']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_3]',number_format($purchase_line->variations->additional_expense_value_3), ['class' => 'form-control input-sm additional_extra_expense_value_3 input_number', 'id' => 'additional_extra_expense_value_3']); !!}
            </td>
            <td>
           
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_4]',number_format($purchase_line->variations->additional_expense_value_4), ['class' => 'form-control input-sm additional_extra_expense_value_4 input_number ', 'id' => 'additional_extra_expense_value_4']); !!}
           
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_5]',number_format($purchase_line->variations->additional_expense_value_5), ['class' => 'form-control input-sm additional_extra_expense_value_5 input_number', 'id' => 'additional_extra_expense_value_5']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_6]',number_format($purchase_line->variations->additional_expense_value_6), ['class' => 'form-control input-sm additional_extra_expense_value_6 input_number', 'id' => 'additional_extra_expense_value_6']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_7]',number_format($purchase_line->variations->additional_expense_value_7), ['class' => 'form-control input-sm additional_extra_expense_value_7 input_number', 'id' => 'additional_extra_expense_value_7']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_8]',number_format($purchase_line->variations->additional_expense_value_8), ['class' => 'form-control input-sm additional_extra_expense_value_8 input_number', 'id' => 'additional_extra_expense_value_8']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_9]',number_format($purchase_line->variations->additional_expense_value_9), ['class' => 'form-control input-sm additional_extra_expense_value_9 input_number', 'id' => 'additional_extra_expense_value_9']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_10]',number_format($purchase_line->variations->additional_expense_value_10), ['class' => 'form-control input-sm additional_extra_expense_value_10 input_number', 'id' => 'additional_extra_expense_value_10']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_11]',number_format($purchase_line->variations->additional_expense_value_11), ['class' => 'form-control input-sm additional_extra_expense_value_11 input_number', 'id' => 'additional_extra_expense_value_11']); !!}
            </td>
            <td>
            {!! Form::text('purchases[' . $loop->index . '][additional_extra_expense_value_12]',number_format($purchase_line->variations->additional_expense_value_12), ['class' => 'form-control input-sm additional_extra_expense_value_12 input_number', 'id' => 'additional_extra_expense_value_12']); !!}
            </td>
            @endif
