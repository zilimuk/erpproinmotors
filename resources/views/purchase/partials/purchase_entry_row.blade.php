@foreach( $variations as $variation)
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif>
        ...
        <td class="{{$hide_tax}}">
            <div class="input-group">
                <select name="purchases[{{ $row_count }}][purchase_line_tax_id]" class="form-control select2 input-sm purchase_line_tax_id" placeholder="'Please Select'">
                    ...
                    {{-- {{ $tax->amount }} --}}
                        <option value="{{ $tax->id }}" data-tax_amount="0" @if( $tax_id == $tax->id && $hide_tax != 'hide') selected @endif >{{ $tax->name }}</option>
                    @endforeach
                </select>
        ...
        <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_1]',number_format($variation->additional_expense_value_1), ['class' => 'form-control input-sm additional_extra_expense_value_1 input_number', 'id' => 'additional_extra_expense_value_1']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_2]',number_format($variation->additional_expense_value_2), ['class' => 'form-control input-sm additional_extra_expense_value_2 input_number', 'id' => 'additional_extra_expense_value_2']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_3]',number_format($variation->additional_expense_value_3), ['class' => 'form-control input-sm additional_extra_expense_value_3 input_number', 'id' => 'additional_extra_expense_value_3']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_4]',number_format($variation->additional_expense_value_4), ['class' => 'form-control input-sm additional_extra_expense_value_4 input_number', 'id' => 'additional_extra_expense_value_4']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_5]',number_format($variation->additional_expense_value_5), ['class' => 'form-control input-sm additional_extra_expense_value_5 input_number', 'id' => 'additional_extra_expense_value_5']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_6]',number_format($variation->additional_expense_value_6), ['class' => 'form-control input-sm additional_extra_expense_value_6 input_number', 'id' => 'additional_extra_expense_value_6']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_7]',number_format($variation->additional_expense_value_7), ['class' => 'form-control input-sm additional_extra_expense_value_7 input_number', 'id' => 'additional_extra_expense_value_7']); !!}
       </td>
       <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_8]',number_format($variation->additional_expense_value_8), ['class' => 'form-control input-sm additional_extra_expense_value_8 input_number', 'id' => 'additional_extra_expense_value_8']); !!}
       </td>
        <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_9]',number_format($variation->additional_expense_value_9), ['class' => 'form-control input-sm additional_extra_expense_value_9 input_number', 'id' => 'additional_extra_expense_value_9']); !!}
       </td>
        <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_10]',number_format($variation->additional_expense_value_10), ['class' => 'form-control input-sm additional_extra_expense_value_10 input_number', 'id' => 'additional_extra_expense_value_10']); !!}
       </td>
        <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_11]',number_format($variation->additional_expense_value_11), ['class' => 'form-control input-sm additional_extra_expense_value_11 input_number', 'id' => 'additional_extra_expense_value_11']); !!}
       </td>
        <td>
            {!! Form::text('purchases[' . $row_count . '][additional_extra_expense_value_12]',number_format($variation->additional_expense_value_12), ['class' => 'form-control input-sm additional_extra_expense_value_12 input_number', 'id' => 'additional_extra_expense_value_12']); !!}
       </td>
       @endif
