    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.add_extra_charges', in_array('purchase.add_extra_charges', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('purchase.add_extra_charges') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.update_extra_charges', in_array('purchase.update_extra_charges', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('purchase.update_extra_charges') }}
              </label>
            </div>
          </div>
        </div>
