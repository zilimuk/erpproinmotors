...
<div class="row">
	...
	@if(!empty($receipt_details->logo))
		<img style="max-height: 50px; width: auto;" src="{{$receipt_details->logo}}" class="img img-responsive center-block">
	@endif
...
<div class="col-xs-12">
	<div class="col-xs-6">
		...
		@if(!empty($receipt_details->location_custom_fields))
			<br><b>@lang('lang_v1.business_location_custom_field_1'):</b> &nbsp;{{ $receipt_details->location_custom_fields }}
		@endif
		</p>
		<p>
				...
				@forelse($receipt_details->lines as $line)
					<tr>
						...
						<td>
                            ...
                            @if(!empty($line['sub_sku'])), <b>@lang('product.sku')</b>: {{$line['sub_sku']}} @endif @if(!empty($line['brand'])), <b>@lang('product.brand')</b>:{{$line['brand']}}, @endif @if(!empty($line['cat_code'])), {{$line['cat_code']}}@endif
                            ...
                            @endif 
							<b>@lang('product.transmission')</b>: {{$line['transmission']}},
							<b>@lang('product.engine_capacity')</b>:{{$line['engine_capacity']}}
							<b>@lang('product.seats')</b>:{{$line['seats']}}
							<b>@lang('product.doors')</b>:{{$line['doors']}}
							<b>@lang('product.color')</b>:{{$line['color']}}
							<b>@lang('product.mileage')</b>:{{$line['mileage']}}
							<b>@lang('product.fuel_type')</b>:{{$line['fuel_type']}}
							<b>@lang('product.weight')</b>:{{$line['weight']}}
							<b>@lang('product.dimension')</b>:{{$line['dimension']}}
							<b>@lang('product.steering')</b>:{{$line['sterring']}}
