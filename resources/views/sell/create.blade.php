	...
	@component('components.widget', ['class' => 'box-solid','title' => __('lang_v1.release_details')])
			...
			<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text('carryout_date', @format_datetime('now'), ['class' => 'form-control','id'=>'carryout_date','readonly']); !!}
					</div>
			</div>
			</div>
			<div class="col-md-9">
				...
				{!! Form::label('carryout_details',__('lang_v1.carryout_details').':') !!}
				   {!! Form::textarea('carryout_details',null, ['class' => 'form-control','placeholder' => __('lang_v1.carryout_details') ,'rows' => '3', 'cols'=>'30']); !!}
				</div>
			</div>
			</div>
	@endcomponent
