...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	@if($is_enabled_download_pdf && $transaction->type != 'sales_order')
		...
		@endcan
	@endif
@component('components.widget', ['class' => 'box-solid','title' => __('lang_v1.release_details')])
			<div class="row">
			<div class="col-md-3">
			<div class="form-group">
					{!! Form::label('carryout_date', __('lang_v1.carryout_date') . ':*') !!}
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</span>
						{!! Form::text('carryout_date', $transaction->carryout_date, ['class' => 'form-control','id'=>'carryout_date','readonly']); !!}
					</div>
			</div>
			</div>
			<div class="col-md-9">
				<div class="form-group">
				{!! Form::label('carryout_details',__('lang_v1.carryout_details').':') !!}
				@if($transaction->carryout_details == 'Null')
				   {!! Form::textarea('carryout_details',__('lang_v1.carryout_details'), ['class' => 'form-control','placeholder' => __('lang_v1.carryout_details') ,'rows' => '3', 'cols'=>'30']); !!}
				@else
				   {!! Form::textarea('carryout_details',$transaction->carryout_details, ['class' => 'form-control','placeholder' => __('lang_v1.carryout_details') ,'rows' => '3', 'cols'=>'30']); !!}
				@endif
				</div>
			</div>
			</div>
